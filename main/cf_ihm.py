...
# Controler
class controler:
    def __init__(self, main_app, shapes,
                 start_shape=0, start_amps=(1.0, 1.0, 1.0, 1.0)):
    ...
    def apply_param(self):
        ...
        for idx in range(len(shape_params)):
